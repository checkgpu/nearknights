        ...
        if (_config.textType === "normal") {
            ...
            if (_config.parentObject !== null) {
                ...
                if (_config.align === "center") {
                    window.Phaser.Display.Align.In.Center(textObj, _config.parentObject, _config.offsetX, _config.offsetY);
                } else if (_config.align === "left") {
                    window.Phaser.Display.Align.In.LeftCenter(textObj, _config.parentObject, _config.offsetX, _config.offsetY);
                } else if (_config.align === "right") {
                    window.Phaser.Display.Align.In.RightCenter(textObj, _config.parentObject, _config.offsetX, _config.offsetY);
                } else if (_config.align === "top-center") {
                    window.Phaser.Display.Align.In.TopCenter(textObj, _config.parentObject, _config.offsetX, _config.offsetY);
                }
            }
        ...
        if (textObj.isAnimating === false) {
            ...
            if (config.animation === "physics") {
                ...
                if (config.pointX.length > 0 && config.pointY.length > 0) {
                    var startPoint = new window.Phaser.Math.Vector2(config.pointX[0], config.pointY[0]);
                    var controlPoint1 = new window.Phaser.Math.Vector2(config.pointX[1], config.pointY[1]);
                    var controlPoint2 = new window.Phaser.Math.Vector2(config.pointX[2], config.pointY[2]);
                    var endPoint = new window.Phaser.Math.Vector2(config.pointX[3], config.pointY[3]);
                    var curve = new window.Phaser.Curves.CubicBezier(startPoint, controlPoint1, controlPoint2, endPoint);
                ...
                var startPoint = new window.Phaser.Math.Vector2(textObj.x + (25 * invertOffset), textObj.y - 25);
                var controlPoint1 = new window.Phaser.Math.Vector2(textObj.x - (50 * invertOffset), textObj.y - 50);
                var controlPoint2 = new window.Phaser.Math.Vector2(textObj.x + (75 * invertOffset), textObj.y - 75);
                var endPoint = new window.Phaser.Math.Vector2(textObj.x - (25 * invertOffset), textObj.y - 100);
                var curve = new window.Phaser.Curves.CubicBezier(startPoint, controlPoint1, controlPoint2, endPoint);
...
window.FloatingNumbersPluginC = FloatingNumbersPlugin;